...
namespace tdb.account.repository
{
    ...
    public class RoleRepos : TdbRepository<RoleInfo>, IRoleRepos
    {
        ...
        /// <param name="roleID">角色ID</param>
        /// <returns></returns>
        public async Task<List<int>> GetAuthorityIDsAsync(int roleID)
        {
        ...
        /// <returns></returns>
        private async Task SaveRoleAuthorityConfigAsync(int roleID, List<RoleAuthorityConfig> lstAuthority)
        {
        ...
        /// <param name="roleID">角色ID</param>
        /// <returns></returns>
        private string CacheKeyRoleInfo(int roleID)
        {
        ...
        /// <param name="roleID">角色ID</param>
        /// <returns></returns>
        private string CacheKeyRoleAuthorityID(int roleID)
        {
