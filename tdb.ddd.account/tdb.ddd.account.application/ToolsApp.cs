...
namespace tdb.ddd.account.application
{
    ...
    public class ToolsApp
    {
        ...
        private async Task InitDataRoleAsync()
        {
            ...
            superAdminRole.SetLstAuthorityID(new List<long>() { Cst.AuthorityID.AccountUserManage });
            ...
            accountAdminRole.SetLstAuthorityID(new List<long>() { Cst.AuthorityID.AccountUserManage });
        ...
        private async Task InitDataUserAsync()
        {
            ...
            superAdminUser.SetLstRoleID(new List<long>() { Cst.RoleID.SuperAdmin });
